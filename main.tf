# Sentinel Service Policies GCP_CAS_CASUBORDINATE
# SUBORDINATE google_privateca_certificate_authority.type = SUBORDINATE
# google_privateca_certificate_authority.subordinate_config.certificate_authority is fail scenario with block empty
...
resource "google_privateca_certificate_authority" "root-ca" {
  ...
  depends_on = [data.google_kms_crypto_key_version.secret_version]
}
